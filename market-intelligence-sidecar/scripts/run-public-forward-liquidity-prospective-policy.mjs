...
console.log(JSON.stringify({
  status: 'PROSPECTIVE_POLICY_V2_FROZEN',
  ...
  cohortDigest: artifact.cohort.cohortDigest,
  ...
  captureSelectionPolicyDigest: artifact.captureSelectionPolicy.captureSelectionPolicyDigest,
  captureSelectionPolicy: artifact.captureSelectionPolicy.selectionPolicy,
  ...
  captureSlotCounts: artifact.captureSelectionPolicy.slotCounts,
  scheduleActivationRequired: artifact.captureSelectionPolicy.scheduleActivationRequired,
  outcomeHorizonMs: artifact.outcomeMethodology.outcomeHorizonMs,
  historicalObservationCredit: 0,
  newProspectiveSampleN: 0,
  fullCostReady: false,
  evidenceComplete: 0,

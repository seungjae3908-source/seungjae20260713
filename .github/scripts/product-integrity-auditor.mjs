...
export const P1_SCOPE_RECONCILIATION = Object.freeze({
  ...
  CG011: { classification: 'EXISTING_OWNER', owner: 'Paper-owner task Repair and activate paper risk flow; historical #1001/#891', ownerAcknowledgement: PAPER_OWNER_ACK, dependencyOwner: '#1085 integration must consume, not redefine, measured cost contract' },
  CG012: { classification: 'EXISTING_OWNER', owner: 'Paper-owner task Repair and activate paper risk flow; historical #1001/#891', ownerAcknowledgement: PAPER_OWNER_ACK, dependencyOwner: '#1085 integration must preserve all cost evidence, not default missing costs to zero' },
  CG013: { classification: 'EXISTING_OWNER', owner: 'Paper-owner task Repair and activate paper risk flow; validation namespace #547 retained', ownerAcknowledgement: PAPER_OWNER_ACK, dependencyOwner: '#1085 wiring after canonical genuine receipt contract; missing consumer is not merely a runtime-evidence gap' },

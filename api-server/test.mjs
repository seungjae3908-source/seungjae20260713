...
const groups = {
  ...
  phase5: [
    path.join(root, 'src/services/backtest-paper-handoff.service.test.ts'),
  ...
  phase12: [
    ...
    path.join(root, 'src/features/account-readonly/tests/account-readonly.test.ts'),
    ...
    path.join(root, 'src/features/account-readonly/account-readonly.portfolio-adapter.test.ts'),
    path.join(root, 'src/features/account-readonly/account-readonly.portfolio-source.test.ts'),
    path.join(root, 'src/features/account-readonly/account-readonly.journal-history.test.ts'),
    path.join(root, 'src/features/account-readonly/account-readonly.kiwoom-journal-history.test.ts'),
    path.join(root, 'src/features/account-readonly/tests/kiwoom-readonly-journal.test.ts'),
    path.join(repositoryRoot, 'stock-analyzer/src/lib/unified-journal-safety.test.ts'),

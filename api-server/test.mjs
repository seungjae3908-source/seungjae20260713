...
const groups = {
  ...
  phase9: [
    ...
    path.join(root, 'src/services/profit-first-signal.service.test.ts'),
    path.join(root, 'src/services/profit-first-runtime.service.test.ts'),
    path.join(root, 'src/services/profit-first-ai-evidence.service.test.ts'),
    path.join(root, 'src/services/profit-first-telegram-report.service.test.ts'),

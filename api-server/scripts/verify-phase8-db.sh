...
run_sql "re-run Phase 8 migration idempotently" "api-server/supabase/migrations/2026080202_release_candidate_permissions_phase8.sql"
run_sql "execute real RLS integration queries" "api-server/supabase/test/phase8_rls_integration.sql"
...
run_sql "rollback Phase 8 migration" "api-server/supabase/migrations/2026080202_release_candidate_permissions_phase8.down.sql"
...
run_sql "reapply Phase 8 migration" "api-server/supabase/migrations/2026080202_release_candidate_permissions_phase8.sql"

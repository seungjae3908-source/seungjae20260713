...
requireText(production, 'default: /api/healthz/data-plane', 'official production workflow data-plane default');
...
console.log('- Required CI 6/6 exact-run provenance: verified');
...
console.log('- Dedicated /api/healthz/data-plane probe is explicitly dispatched');

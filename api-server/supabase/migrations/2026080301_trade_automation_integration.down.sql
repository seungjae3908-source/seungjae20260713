...
drop table if exists public.trade_order_plans;
drop table if exists public.trade_exchange_connections;
drop table if exists public.trade_automation_profiles;
commit;

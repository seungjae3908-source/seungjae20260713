...
def build_research_overview(state_root=DEFAULT_STATE_ROOT):
    ...
    return {
        ...
        'state': {
            'present': any(cycle.get('present') for cycle in cycles) or paper_runtime.get('present') or paper_ledger.get('present') or shadow_records.get('present') or liquidity_independence.get('present') or candidate_performance.get('present') or temporal_crypto.get('present'),
...
DIGEST64_PATTERN = __import__('re').compile(r'^[0-9a-f]{64}CANDIDATE_ID_PATTERN = __import__('re').compile(r'^(?:phase3-candidate:sha256:|paper-candidate-v1:)[0-9a-f]{64}$')
SAFE_ID_PATTERN = __import__('re').compile(r'^[A-Za-z0-9._:-]{1,160}$')
CANDIDATE_COUNT_KEYS = (
    'effectiveIndependentMarketN', 'candidateMatchedN', 'LONG_SIGNAL_N', 'SHORT_SIGNAL_N', 'NO_TRADE_N',
    'Entry_N', 'Position_N', 'PositionObservation_N', 'Settlement_N',
...
TEMPORAL_SYMBOL_PATTERN = __import__('re').compile(r'^[A-Z0-9]{3,30}CANDIDATE_ID_PATTERN = __import__('re').compile(r'^(?:phase3-candidate:sha256:|paper-candidate-v1:)[0-9a-f]{64}$')
SAFE_ID_PATTERN = __import__('re').compile(r'^[A-Za-z0-9._:-]{1,160}$')
CANDIDATE_COUNT_KEYS = (
    'effectiveIndependentMarketN', 'candidateMatchedN', 'LONG_SIGNAL_N', 'SHORT_SIGNAL_N', 'NO_TRADE_N',
    'Entry_N', 'Position_N', 'PositionObservation_N', 'Settlement_N',
...
DIGEST64_PATTERN = __import__('re').compile(r'^[0-9a-f]{64}CANDIDATE_COUNT_KEYS = (
    'effectiveIndependentMarketN', 'candidateMatchedN', 'LONG_SIGNAL_N', 'SHORT_SIGNAL_N', 'NO_TRADE_N',
    'Entry_N', 'Position_N', 'PositionObservation_N', 'Settlement_N',
    'TRAIN_N', 'VALIDATION_N', 'OOS_N', 'WIN_N', 'LOSS_N', 'BREAKEVEN_N',
)
...
TEMPORAL_SYMBOL_PATTERN = __import__('re').compile(r'^[A-Z0-9]{3,30}CANDIDATE_COUNT_KEYS = (
    'effectiveIndependentMarketN', 'candidateMatchedN', 'LONG_SIGNAL_N', 'SHORT_SIGNAL_N', 'NO_TRADE_N',
    'Entry_N', 'Position_N', 'PositionObservation_N', 'Settlement_N',
    'TRAIN_N', 'VALIDATION_N', 'OOS_N', 'WIN_N', 'LOSS_N', 'BREAKEVEN_N',
)
...
CANDIDATE_ID_PATTERN = __import__('re').compile(r'^(?:phase3-candidate:sha256:|paper-candidate-v1:)[0-9a-f]{64}CANDIDATE_COUNT_KEYS = (
    'effectiveIndependentMarketN', 'candidateMatchedN', 'LONG_SIGNAL_N', 'SHORT_SIGNAL_N', 'NO_TRADE_N',
    'Entry_N', 'Position_N', 'PositionObservation_N', 'Settlement_N',
    'TRAIN_N', 'VALIDATION_N', 'OOS_N', 'WIN_N', 'LOSS_N', 'BREAKEVEN_N',
)
...
SAFE_ID_PATTERN = __import__('re').compile(r'^[A-Za-z0-9._:-]{1,160}CANDIDATE_COUNT_KEYS = (
    'effectiveIndependentMarketN', 'candidateMatchedN', 'LONG_SIGNAL_N', 'SHORT_SIGNAL_N', 'NO_TRADE_N',
    'Entry_N', 'Position_N', 'PositionObservation_N', 'Settlement_N',
    'TRAIN_N', 'VALIDATION_N', 'OOS_N', 'WIN_N', 'LOSS_N', 'BREAKEVEN_N',
)

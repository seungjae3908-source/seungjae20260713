    ...
    <article className="rounded-3xl border border-card-border bg-card p-4 shadow-sm">
      ...
      >
        <div className="flex min-w-0 items-start gap-1">
          <FavoriteButton item={{ ticker: row.ticker, name: row.name, market: row.market, currency: row.currency }} />
        ...
        <div className="flex shrink-0 items-end gap-1 text-right">
          ...
          <InstrumentAlertButton instrument={{ ticker: row.ticker, name: row.name, market: row.market }} />
        </div>
      </button>

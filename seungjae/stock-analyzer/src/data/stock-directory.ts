// Local stock database used as the source of truth for search matching.
// Every entry here must also exist in `STOCKS` (src/data/stocks.ts) so the
// detail page can render full analysis data for it.
...
export const STOCK_DIRECTORY: StockDirectoryEntry[] = [
  ...
  { ticker: "CMMB", name: "Chemomab Therapeutics" },

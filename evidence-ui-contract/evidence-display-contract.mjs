...
/**
 * Fail-closed UI evidence projection.
 *
 * A numeric zero is a real VALUE. Missing/unknown/stale/unavailable/permission
 * states never fall back to zero. Callers may pass a formatter only for VALUE.
 */

...
export function publicContract() {
  return {
    ...
    serverFailureProtection: {
      version: "V0_7",
      healthEndpoint: "/v1/protection/health",
      heartbeatEndpoint: "/v1/protection/heartbeat",
      intentEndpoint: "/v1/paper/orders/:orderId/protection/intent",
      acknowledgementEndpoint: "/v1/paper/orders/:orderId/protection/ack",
      reconciliationPreviewEndpoint: "/v1/paper/orders/:orderId/protection/reconciliation/preview",
      unattendedPaperDefaultEnabled: false,
      heartbeatRequiredWhenEnabled: true,
      heartbeatPersistedAcrossRestart: false,
      providerNativeProtectionRequiredForFutureUnattendedLive: true,
      providerNativeProtectionSupportAssumed: false,
      providerProtectionDurabilityRequired: true,
      authenticatedProtectionReadAdapterRequired: true,
      authenticatedProtectionReadAdapterEnabled: false,
      filledExposureWithoutProtectionBlocksNewEntry: true,
      pendingProtectionAfterRestartRequiresReconciliation: true,
      automaticInterruptedEntryResubmission: false,
      emergencyIntent: "REDUCE_OR_CLOSE_SIMULATION_ONLY",
    ...
    compoundingCapital: {
      version: "V0_8",
      currency: "KRW",
      initialManagedCapitalLimitKrw: 1_000_000,
      profitMilestonePercent: 10,
      profitReservePercent: 5,
      healthEndpoint: "/v1/capital/health",
      settlementEndpoint: "/v1/capital/settlement",
      capitalAdmissionDefaultEnabled: false,
      settlementIngestDefaultEnabled: false,
      settlementAuthority: "CALLER_SUPPLIED_SIMULATED_FLAT_EVIDENCE_ONLY",
      positionsFlatRequiredForSettlement: true,
      openOrderCountZeroRequiredForSettlement: true,
      managedExposureZeroRequiredForSettlement: true,
      highWatermarkNeverDecreasesOnLoss: true,
      drawdownReducesEffectiveTradingCapital: true,
      recoveryToHighWatermarkDoesNotCreateReserve: true,
      ...
      concurrentNewEntryAdmissionSerialized: true,
      directlyKrwValuedNewExposure: ["KR_STOCK", "CRYPTO_SPOT:UPBIT:KRW-*"],
      foreignCurrencyNewExposureRequiresAuthoritativeKrwValuation: true,
      foreignCurrencyKrwValuationAdapterEnabled: false,
      executionAuthority: "NONE",
    ...
    executionQuality: {
      ...
      benchmarkAuthority: "CALLER_SUPPLIED_UNATTESTED_ONLY",
      callerMaySelfAssertServerAttestation: false,
      hardCodedBrokerFees: false,
      hardCodedTaxes: false,
      hardCodedFundingConvention: false,
      fundingMustFallInsideAnalysisWindow: true,
    ...
    persistence: {
      ...
      protectionStateStoredSeparately: true,
      protectionStateChecksum: "SHA256",
      protectionHeartbeatPersisted: false,
      capitalStateStoredSeparately: true,
      capitalStateChecksum: "SHA256",
      capitalReserveStateContainsExternalWithdrawalAuthority: false,
    ...
    reconciliation: {
      ...
      protectionEndpoint: "/v1/paper/orders/:orderId/protection/reconciliation/preview",

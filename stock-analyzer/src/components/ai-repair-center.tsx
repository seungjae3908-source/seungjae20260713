...
function formatDate(value: string): string {
  ...
  return `${month}.${day}. ${period} ${String(hour).padStart(2, "0")}:${minute}`;
}
  ...
  return (
    <details data-settings-uniform-card className="group rounded-2xl border border-primary/30 bg-card p-3 text-center shadow-sm">
      <summary className="relative flex min-h-6 cursor-pointer list-none items-center justify-center px-10 text-center group-open:mb-4\">
        ...
        <span className="absolute right-0 top-1/2 -translate-y-1/2 whitespace-nowrap text-xs font-extrabold leading-none text-primary">
          <span className="group-open:hidden">펼치기</span>
          <span className="hidden group-open:inline">접기</span>
        </span>
      </summary>

      <div className="mt-1 relative flex items-center justify-center gap-2 rounded-lg bg-secondary/60 px-2 py-1.5">
        <p className="break-keep text-center text-[11px] font-bold leading-relaxed text-muted-foreground">
            ...
            return (
              <article key={job.id} className="overflow-hidden rounded-2xl border border-card-border bg-background">
                <button
                  ...
                  className="flex w-full items-center gap-2 p-3 text-center"
                >
                  ...
                  <span className="min-w-0 flex-1 text-center">
                                        <span className="mt-1 block truncate whitespace-nowrap text-center text-[10px] leading-relaxed text-muted-foreground">

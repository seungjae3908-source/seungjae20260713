...
function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const wide = location.startsWith('/scanner') || location.startsWith('/ai-chart') || location.startsWith('/__phase11-technical-workspace-e2e') || location.startsWith('/__phase12-scanner-markets-e2e');

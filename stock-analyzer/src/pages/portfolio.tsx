									...
									<label className="block">
										...
										<div className="relative mt-2">
											...
											<input
												...
												required
												className="h-12 w-full rounded-2xl border border-card-border bg-background pl-10 pr-3 text-sm font-bold outline-none focus:border-primary"
											/>
										</div>
									</label>

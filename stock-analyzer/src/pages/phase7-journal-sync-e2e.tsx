...
function unifiedJournal() {
  ...
  return {
    ...
    toss: { provider: 'TOSS', officialSpecVersion: '1.2.14', paidStatus: 'PAID_STATUS_UNVERIFIED', liveReadIntegration: 'MEMBER_CONFIGURED_READ_ONLY', contractNormalizerAvailable: true, executionGranularity: 'ORDER_CUMULATIVE_AGGREGATE_NO_FILL_ID', livePrivateRequests: 0, actualOrders: 0 },
    brokerImport: { requested: true, importedRecords: 0, privateReadRequests: 0, privateMutationRequests: 0, providers: null },

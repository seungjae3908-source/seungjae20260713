...
export default function MorePage() {
  ...
  const [backupStatus, setBackupStatus] = useState('백업 대기 중');
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-y-auto overscroll-contain bg-background text-center">
      ...
      <main className="min-h-0 flex-1 space-y-4 overflow-y-auto overscroll-contain p-4 pb-24">
        <section className="rounded-3xl border border-card-border bg-card p-4 shadow-sm">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">관심종목, 알림, 포트폴리오를 계정에 저장합니다.</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">매수가, 수량, 평가손익과 수익률을 확인합니다.</p>
            </div>
          </button>
        </section>
        ...
        <section className="rounded-3xl border border-card-border bg-card p-4 shadow-sm">
          <div className="mb-3">
            <h2 className="text-sm font-extrabold">백업 / 복원</h2>

            <p className="mt-1 break-keep text-xs leading-relaxed text-muted-foreground">
              관심종목, 알림, 설정 데이터를 파일로 저장하고 다시 불러옵니다.
            </p>
          </div>

  ...
  return (
    <main className="h-full overflow-y-auto overscroll-contain bg-background pb-24" data-testid="strategy-promotion-page">
      <div className="mx-auto w-full max-w-7xl space-y-4 px-3 py-4 sm:px-5">
        ...
        {query.data && items.length === 0 ? <section data-testid="strategy-promotion-empty" className="rounded-3xl border border-card-border bg-card p-8 text-center text-sm text-muted-foreground">No strategy evidence matches the current filters.</section> : null}

import type { ScannerStrategyMode, ScannerTimeframe } from '@/lib/signal-scanner';
...
const PROFILE_MAP: Record<FrontendScannerMarket, Record<ScannerStrategyMode, Omit<ScannerUiProfile, 'market' | 'strategyMode'>>> = {
  KR_STOCK: {
    ...
    swing: { timeframe: '60m', conditions: ['ma_breakout', 'volume_spike', 'ai_score'], indicators: ['EMA20', 'EMA60', 'RSI14', 'MACD', 'ADX14', 'ATR14'], profileVersion: VERSION },
  ...
  CRYPTO_SPOT: {
    scalping: { timeframe: '15m', conditions: ['trend_alignment', 'volume_spike', 'breakout', 'pullback', 'williams_atr'], indicators: ['EMA12', 'EMA26', 'VWAP', 'RSI14', 'MACD', 'ATR14'], profileVersion: VERSION },
    ...
    position: { timeframe: '4H', conditions: ['trend_alignment', 'breakout', 'pullback'], indicators: ['EMA20', 'EMA60', 'SMA120', 'ADX14', 'ATR14', 'OBV'], profileVersion: VERSION },
  },
  CRYPTO_FUTURES: {
    ...
    swing: { timeframe: '60m', conditions: ['trend_alignment', 'volume_spike', 'breakout', 'pullback'], indicators: ['EMA20', 'EMA60', 'RSI14', 'MACD', 'ADX14', 'ATR14'], profileVersion: VERSION },
    position: { timeframe: '4H', conditions: ['trend_alignment', 'breakout', 'pullback'], indicators: ['EMA20', 'EMA60', 'SMA120', 'ADX14', 'ATR14', 'OBV'], profileVersion: VERSION },
  },
};

export function getScannerUiProfile(market: FrontendScannerMarket, strategyMode: ScannerStrategyMode): ScannerUiProfile {
...
export const SCANNER_STRATEGY_OPTIONS: readonly { value: ScannerStrategyMode; label: string; description: string }[] = Object.freeze([

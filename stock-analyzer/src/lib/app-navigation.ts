...
export const APP_ROUTES = {
  ...
  stocksKr: '/stocks/kr',
  stocksUs: '/stocks/us',
  coinsSpot: '/coins/spot',
  coinsFutures: '/coins/futures',
...
export const APP_NAVIGATION: readonly NavigationGroup[] = [
  ...
  },
  {
    ...
    menu: [
      ...
      {
        id: 'market-rankings',
        href: APP_ROUTES.unifiedMarketRankings,
        label: '시장 순위',
        icon: 'ranking',
      },
      {
      ...
      { id: 'alerts', href: APP_ROUTES.alerts, label: '가격알림', icon: 'alerts' },
    ],
  },
  {
    id: 'technical',
  ...
  },
  {
    ...
    menu: [
      { id: 'market-overview', href: APP_ROUTES.marketOverview, label: '시장 시황', icon: 'market' },
...
export const APP_ROUTE_PRESENTATIONS: readonly AppRoutePresentation[] = [
  ...
  { id: 'asset-search', title: '통합 종목검색', breadcrumb: ['종목', '통합 종목검색'], groupId: 'assets', exactPaths: [APP_ROUTES.assets, APP_ROUTES.unifiedSearchAlias] },
  { id: 'stocks-kr', title: '국내주식 정보', breadcrumb: ['종목', '국내주식'], groupId: 'assets', exactPaths: [APP_ROUTES.stocksKr] },
  { id: 'stocks-us', title: '미국주식 정보', breadcrumb: ['종목', '미국주식'], groupId: 'assets', exactPaths: [APP_ROUTES.stocksUs] },
  { id: 'coins-spot', title: '코인 현물 정보', breadcrumb: ['종목', '코인 현물'], groupId: 'assets', exactPaths: [APP_ROUTES.coinsSpot] },
  { id: 'coins-futures', title: '코인 선물 정보', breadcrumb: ['종목', '코인 선물'], groupId: 'assets', exactPaths: [APP_ROUTES.coinsFutures] },
  { id: 'market-rankings', title: '시장 순위', breadcrumb: ['종목', '시장 순위'], groupId: 'assets', exactPaths: [APP_ROUTES.unifiedMarketRankings] },
  ...
  { id: 'alerts', title: '가격알림', breadcrumb: ['종목', '가격알림'], groupId: 'assets', exactPaths: [APP_ROUTES.alerts] },
  ...
  { id: 'auto-trading', title: '자동매매·승인형 주문', breadcrumb: ['기술', '자동매매·승인형 주문'], groupId: 'technical', exactPaths: [APP_ROUTES.autoTrading] },
  ...
  { id: 'market-overview', title: '시장 시황', breadcrumb: ['정보', '시장 시황'], groupId: 'information', exactPaths: [APP_ROUTES.marketOverview] },
  ...
  { id: 'crypto-search-redirect', title: '암호화폐 검색 이동', breadcrumb: ['종목', '통합 종목검색'], exactPaths: [APP_ROUTES.cryptoSearchRedirect], transient: true },

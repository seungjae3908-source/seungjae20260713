...
export const APP_NAVIGATION: readonly NavigationGroup[] = [
  ...
  },
  {
    ...
    menu: [
      { id: 'ai-chat', href: APP_ROUTES.aiChat, label: 'AI 상담', icon: 'chat', capability: 'canAccessBasicInfo' },
      {
        id: 'portfolio',
      ...
      { id: 'market-overview', href: APP_ROUTES.marketOverview, label: '시장 브리핑', icon: 'market' },
    ],
  },
  {
    id: 'settings',
...
export const APP_ROUTE_PRESENTATIONS: readonly AppRoutePresentation[] = [
  ...
  { id: 'market-overview', title: '시장 브리핑', breadcrumb: ['정보', '시장 브리핑'], groupId: 'information', exactPaths: [APP_ROUTES.marketOverview] },
  ...
  { id: 'ai-chat', title: 'AI 상담', breadcrumb: ['정보', 'AI 상담'], groupId: 'information', exactPaths: [APP_ROUTES.aiChat] },
